...
import makeupHeaderImg from '../assets/MakeupHeader.png';
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const makeupCategories = categoriesData.filter(cat => {
        ...
        const filteredCategories = makeupCategories.length ? makeupCategories : categoriesData;
        if (!makeupCategories.length) {
          console.warn('No strict makeup categories found - showing all categories');
        }
      ...
      <Container maxWidth="lg" sx={{ py: 6, mt: -2 }}>
        ...
        {categories.length === 0 ? (
          <Typography align="center" sx={{ py: 4 }}>
            No makeup services available at this time.
          </Typography>
        ) : (
