...
import bodyHeaderImg from '../assets/BodyHeader.png';

const BodyServicesPage = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const bodyCategories = categoriesData.filter(cat => {
        ...
        const filteredCategories = bodyCategories.length ? bodyCategories : categoriesData;
        if (!bodyCategories.length) {
          console.warn('No strict body treatment categories found - showing all categories');
        }
      ...
      <Container maxWidth="lg" sx={{ py: 6, mt: -2 }}>
        {categories.length === 0 ? (
          <Typography align="center" sx={{ py: 4 }}>
            No body services available at this time.
          </Typography>
        ) : (
...
export default BodyServicesPage;