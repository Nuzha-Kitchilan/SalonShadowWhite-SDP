...
// const { savePaymentDetails } = require('../models/paymentModel');
...
//     const calculatedAmount = Math.floor(amount * 100);
...
//       payment_amount,
//       is_first_time = false,
//       selected_date,  // Note: using selected_date not appointment_date
//       selected_time,  // Note: using selected_time not appointment_time
//       services = [],
//       stylist_ids = []
//     } = req.body;
...
//     res.status(201).json({
//       success: true,
//       message: 'Appointment created successfully. Please pay at the salon.',
//       appointment_ID
//     });
...
// // Record Payment details (for both online and Pay at Salon)
...
//     const paymentId = await savePaymentDetails({
//       appointment_ID,
//       customer_ID,
//       payment_amount,
//       payment_status,
...
//THE LAST WORKING CODE WITHOUT FIRST TIME CUSTOMERS
...
//     // Record payment with zero amount_paid since it will be paid at salon
//     await savePaymentDetails({
//       appointment_ID,
//       customer_ID,
//       payment_amount,
...
//     // For online payments, amount_paid should equal payment_amount
//     const finalAmountPaid = payment_type === 'Online' && payment_status === 'Paid' 
//       ? payment_amount 
//       : amount_paid || null;
...
const Stripe = require('stripe');
const stripe = new Stripe(process.env.STRIPE_SECRET_KEY);
// Import the payment model correctly
  ...
  try {
    ...
    const paymentIntent = await stripe.paymentIntents.create({
      ...
      metadata: {
        ...
        appointment_date: String(appointment_date),
        appointment_time: String(appointment_time),
        total_amount: String(amount) // Store original amount
      },
    });
