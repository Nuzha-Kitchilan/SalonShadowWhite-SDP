...
import nailHeaderImg from '../assets/NailHeader.png';

const NailServicesPage = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const nailCategories = categoriesData.filter(cat => {
        ...
        const filteredCategories = nailCategories.length ? nailCategories : categoriesData;
        if (!nailCategories.length) {
          console.warn('No strict nail categories found - showing all categories');
        }
      ...
      <Container maxWidth="lg" sx={{ py: 6, mt: -2 }}>
        {categories.length === 0 ? (
          <Typography align="center" sx={{ py: 4 }}>
            No nail services available at this time.
          </Typography>
        ) : (
...
export default NailServicesPage;