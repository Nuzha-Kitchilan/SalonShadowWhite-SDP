...
import faceHeaderImg from '../assets/FaceHeader.png';

const FacialServicesPage = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const facialCategories = categoriesData.filter(cat => {
        ...
        const filteredCategories = facialCategories.length ? facialCategories : categoriesData;
        if (!facialCategories.length) {
          console.warn('No strict facial categories found - showing all categories');
        }
      ...
      <Container maxWidth="lg" sx={{ py: 6, mt: -2 }}>
        {categories.length === 0 ? (
          <Typography align="center" sx={{ py: 4 }}>
            No facial services available at this time.
          </Typography>
        ) : (
