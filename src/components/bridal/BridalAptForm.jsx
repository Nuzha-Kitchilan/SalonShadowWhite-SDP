...
//         // Handle price as string (like "2000.00" from API) or as number
...
//     // Extract just the IDs from the selected services
...
//     if (!appointmentData.stylists || appointmentData.stylists.length === 0) {
...
//   // Helper function to get service name with a fallback chain
...
//   // Helper function to get stylist name with a fallback chain
...
//   // Get selected services objects from IDs for Autocomplete
...
//       <Card>
//         <CardHeader 
//           title={initialData ? "Edit Bridal Appointment" : "Create Bridal Appointment"} 
//           subheader="Enter appointment details below"
//         />
//         <Divider />
//         <CardContent>
...
//               {/* Services Selection - Using Autocomplete for type-to-search functionality */}
//               <Grid item xs={12} md={6}>
//                 <Autocomplete
//                   multiple
...
//                         <Chip
//                           variant="outlined"
//                           label={`${getServiceName(option)} (${price})`}
//                           {...getTagProps({ index })}
//                           size="small"
//                         />
//                       );
...
//                     (option.service_id || option.service_ID || option.id) === 
//                     (value.service_id || value.service_ID || value.id)
//                   }
//                 />
//               </Grid>
...
//               {/* Stylists Selection */}
//               <Grid item xs={12} md={6}>
//                 <FormControl fullWidth error={!!errors.stylists}>
//                   <InputLabel id="stylists-select-label">Stylists *</InputLabel>
//                   <Select
//                     labelId="stylists-select-label"
//                     id="stylists-select"
//                     multiple
//                     value={appointmentData.stylists}
//                     onChange={handleMultiSelectChange('stylists')}
//                     input={<OutlinedInput label="Stylists *" />}
//                     renderValue={(selected) => (
//                       <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 0.5 }}>
//                         {selected.map((value) => {
//                           const stylist = stylists.find(s => s.stylist_ID === value || s.id === value);
//                           return (
//                             <Chip 
//                               key={value} 
//                               label={stylist ? getStylistName(stylist) : value} 
//                               size="small" 
//                             />
//                           );
//                         })}
...
//                       <MenuItem key={stylist.stylist_ID || stylist.id} value={stylist.stylist_ID || stylist.id}>
//                         {getStylistName(stylist)}
//                       </MenuItem>
//                     ))}
//                   </Select>
//                   {errors.stylists && (
//                     <FormHelperText>{errors.stylists}</FormHelperText>
//                   )}
//                 </FormControl>
//               </Grid>
...
//               {/* Pricing Section */}
//               <Grid item xs={12}>
//                 <Paper elevation={0} sx={{ p: 2, bgcolor: 'background.paper', border: '1px solid #e0e0e0' }}>
...
//                         Calculated Price (based on selected services): ${calculatedPrice.toFixed(2)}
//                       </Typography>
//                     </Box>
