...
//           { category_id: 1, category_name: "Facials" },
//           { category_id: 2, category_name: "Bridal" },
//           { category_id: 3, category_name: "Semi Permanent Make Up" },
//           { category_id: 4, category_name: "Hair Services" },
//           { category_id: 5, category_name: "Skin Treatments" },
//           { category_id: 6, category_name: "Waxing" },
...
//         // Initialize with empty services for each category
//         const servicesObj = {};
...
//         // Set some fallback services for testing
//         if (fallbackCategories.length > 0) {
//           setDemoServices(fallbackCategories[0].category_id);
//         }
//       } finally {
//         setLoadingCategories(false);
//       }
...
//     } catch (err) {
//       console.error(err);
//       setDemoServices(categoryId);
//     } finally {
//       setLoadingServices(false);
//     }
//   };

//   // Set demo services for testing
//   const setDemoServices = (categoryId) => {
//     const demoServicesByCategory = {
//       1: [ // Facials
//         { service_id: 1, service_name: "Acne Treatment", price: 9000, duration: "1 hr 30 mins" },
//         { service_id: 2, service_name: "Pigmentation Treatment", price: 10000, duration: "1 hr" },
//         { service_id: 3, service_name: "Chemical Peels", price: 6000, duration: "30 mins" },
//         { service_id: 4, service_name: "Collagen Induction with Microneedling", price: 9000, duration: "40 mins" },
//       ],
//       5: [ // Skin Treatments
//         { service_id: 5, service_name: "Anti-Aging Treatment", price: 12000, duration: "1 hr 15 mins" },
//         { service_id: 6, service_name: "Hydrating Facial", price: 5000, duration: "45 mins" },
//       ],
//       4: [ // Hair Services
//         { service_id: 7, service_name: "Haircut & Style", price: 3000, duration: "45 mins" },
//         { service_id: 8, service_name: "Hair Coloring", price: 8000, duration: "2 hrs" },
//       ],
//     };
    
//     // Set demo services for the selected category or empty array if no demo data
//     const demoServices = demoServicesByCategory[categoryId] || [];
//     setServices(prev => ({
//       ...prev,
//       [categoryId]: demoServices
//     }));
...
//     // You might want to show a confirmation or update UI
//   };
...
const CategoryMenu = ({ open, onClose, setCurrentView, onBack, customerId }) => {
  ...
  const handleProceed = () => {
    // Save selected services to state or context
    // Proceed to next step in booking flow
    //alert("Proceeding to checkout with " + selectedServices.length + " services");
    // You could navigate to payment or confirmation screen here
  };
