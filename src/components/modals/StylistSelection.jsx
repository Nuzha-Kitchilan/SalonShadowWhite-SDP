...
//           }}
//         >
//           Please choose your preferred stylist for this service
//         </Typography>
//       </Box>
...
//         overflowY: "auto",
//         px: 2,
//         pb: 8, // Add padding at bottom to prevent content from being hidden behind button
//       }}>
//         {loading ? (
//           <Box 
//             sx={{ 
...
const StylistSelectModal = ({ service, onBack, onClose, onStylistSelected }) => {
  ...
  const handleContinue = () => {
    // Pass the selected stylist back to the parent component
