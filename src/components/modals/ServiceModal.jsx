        ...
        {loading ? (
          ...
          <List 
            ...
            sx={{ 
              width: "100%",
              pt: 2,
              pb: 10 // Add extra padding at the bottom for better scrolling
            }}>
            {services.map((service, index) => (
              <React.Fragment key={service.service_id}>
                <ListItem
...
//   const handleServiceClick = (service) => {
//     setSelectedService(service);
//     onNext(service); // Immediately proceed with the selected service
//   };
...
//           {category?.category_name || "Select Service"}
//         </Typography>
//       </Box>
...
//                     transition: "all 0.2s",
//                     "&:hover": {
//                       backgroundColor: "#BEAF9B20",
//                     },
//                   }}
//                 >
//                   <ListItemText
//                     primary={service.service_name}
//                     secondary={`${service.time_duration} mins • $${service.price}`}
//                   />
//                   <ArrowForwardIosIcon sx={{ fontSize: "14px", color: "#BEAF9B" }} />
//                 </ListItem>
