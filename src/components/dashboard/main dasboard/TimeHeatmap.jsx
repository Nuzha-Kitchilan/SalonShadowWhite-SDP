...
const TimeHeatmap = () => {
  ...
  // Colors that match the AppointmentsCard aesthetic but work for heatmap
  const peakColor = '#BEAF9B';
  const heatMapBaseColor = [255, 250, 245]; // very light beige
  const heatMapDeepColor = [190, 175, 155]; // matches BEAF9B
