...
import {
  ...
  TableContainer, Paper, IconButton, Box, Typography,
...
const ApprovedReviews = ({ reviews = [], onDelete, loading = false }) => {
        ...
        <Table>
          ...
          <TableBody>
            {visibleReviews.map((review) => {
              // Safely get properties with fallbacks using the field names
